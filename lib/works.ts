...
export const works: Work[] = [
  {
    ...
    summary:
      "2025年に続く2年目のプロデュース。出演数を10組から26組に、会場をステップ広場の1拠点から街区連動の3拠点へ拡大。ランチタイムから仕事帰りまで、街そのものをステージ化する。",
    highlights: [
      "前年からのアカウント拡大（規模2倍以上）",
      "街区横断の3会場連動運営",
  ...
  },
  {
    ...
    summary:
      "日比谷ステップ広場を主会場に、慶應・早稲田などの学生ビッグバンドから社会人バンドまで10組が出演。日比谷エリアの音楽プログラムの起点となり、翌年の規模2倍以上の発注へとつながった。",
    highlights: [
      "学生〜社会人のビッグバンドを横断キャスティング",
      "翌年の規模拡大（2倍以上）と再発注の起点に",
