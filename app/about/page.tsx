...
const TEAM: TeamMember[] = [
  {
    ...
    bio: [
      "アーティストマージ創業者。親会社の株式会社サグブレインの代表取締役、シンガポール法人 Sagbrain Global Pte. Ltd. の代表取締役 CEO、およびバングラデシュ法人 SAGBRAIN Bangladesh Co., Ltd. の Chairman を兼務。日本・シンガポール・バングラデシュの3カ国にまたがる IT 開発・グローバル展開体制と、エンタメ事業を横断する経営を担う。LIVEXA-OS をはじめとするライブエンタメ・プラットフォーム開発は、両社の協業から生まれている。",
      "自身も複数のビッグバンドでバンドリーダーを務める現役プレイヤー。経営者でありながら、ステージで音を鳴らし続ける現場感覚を持ち合わせている。",
      "ArtistMerge では、音楽プロデュースと事業開発の両輪を担い、街・施設の音楽プログラム運営から、ライブエンタメ統合 OS（LIVEXA-OS）の立ち上げまで指揮する。",
    ],
  },
  {
    name: "五十嵐 誠",
    ...
    titles: [
      ...
      "Trombonist / Arranger / Whistler",
    ],
    bio: [
      "高校でビッグバンドに衝撃を受け、ジャズの道へ。大阪大学 The New Wave Jazz Orchestra でバンドマスターを務め、第31回 YAMANO BIG BAND JAZZ CONTEST 優秀ソリスト賞を受賞。",
      "現在は東京を拠点に、メジャーアーティストのレコーディング、ツアーサポート、音楽番組出演、アレンジ提供で活動。トロンボーン奏者・アレンジャーとしてジャンル横断の表現力・対応力に定評があり、希少な口笛プレイヤーとしても CM 楽曲に参加。",
      "ArtistMerge では音楽制作・編曲チームを統括し、GrooveCast の編曲品質を支えつつ、フラッグシップバンド『日比谷 Vibrant City Jazz Orchestra』のミュージックディレクターを務める。",
    ],
  },
];
